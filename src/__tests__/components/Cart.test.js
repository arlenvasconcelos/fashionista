...
import { CartHeader, CartDetails, CartFooter } from "../../components";
...
describe("Cart Test", () => {
  ...
  it("should render CartHeader", () => {
    expect(wrapper.find(CartHeader)).toBeTruthy();
  });

  it("should find CartDetails", () => {
    expect(wrapper.find(CartDetails)).toBeTruthy();
  });

  it("should find CartFooter", () => {
    expect(wrapper.find(CartFooter)).toBeTruthy();
  });
});
